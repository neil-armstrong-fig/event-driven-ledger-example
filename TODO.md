...
- [ ] **Phase 3 — NEXT ACTION**, step 1 — `domain` package, TDD: failing unit tests for idempotency-key handling (header/message-attribute extraction/shape), shown red before any implementation. **STOP.**
